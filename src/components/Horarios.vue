...
export default {
  ...
  methods:{
    addMedico(){
      //alert('adding name');
      this.$store.commit('ADD_DOCTOR',{nombre: this.nuevoName,apellido: this.nuevoApellido,email: this.nuevoEmail, dia: this.dia,horaent: this.nuevaHoraE,horasal: this.nuevaHoraS});
      $('#modal1').modal('hide');
